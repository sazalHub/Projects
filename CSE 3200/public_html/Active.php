...
<html lang="en">
	...
	<body>
		<div class="big clear" style="">

			<div  class="login clear">
				<p style="height: 35px;font-size: 26px;font-weight: bolder;color: white;background: brown;">GET A SECURITY CODE</p>
				<hr>
				<form action="sendingMail.php" method="POST">
					
					<input type="text" name="send_code_to" placeholder="Roll">

					<button type="submit" name="code_submit">SUBMIT</button>
