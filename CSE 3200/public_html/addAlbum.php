	...
	<body>
		<div class="big clear">
			...
			<div  class="login clear" style="height: auto;">
				<p style="height: 35px;font-size: 26px;font-weight: bolder;color: white;background: brown;">Add an Album</p>
				<hr>
				<form method="POST" action="Add_Album.php?added_by=<?php echo $roll; ?>" style="height: auto;">
				    ...
				    <div class="row" style="width: 100%;display: ruby;">
				        ...
				        <input type="text" id="album_name" name="album_Name" placeholder="album name...">
				    ...
				    <div class="row" style="width: 100%;">
				        ...
				        <textarea id="album_desc" name="album_Desc" rows="10" cols="50"></textarea>

				    </div>

				    <br>

					<button type="submit" name="add_album">SUBMIT</button>
