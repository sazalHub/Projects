	...
	<body>
		<div class="big clear">
			...
			<div  class="login clear" style="height: auto;">
				...
				<hr>
				<form method="POST" action="Add_Images.php?album_name=<?php echo $album_name; ?>" style="height: auto;" enctype="multipart/form-data">
				    ...
				    <div class="row" style="width: 100%;display: ruby;">
				        ...
				        <p style="font-size: 20px;font-weight: bold;margin-top: 10px;"><?php echo $album_name; ?><p>

				    </div>

				    <input type="file" name="img[]" multiple="multiple">

					<button type="submit" name="add_these_images">SUBMIT</button>
