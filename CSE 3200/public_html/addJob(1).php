	...
	<body>
		<div class="big clear">
			...
			<div  class="login clear" style="height: auto;">
				<p style="height: 35px;font-size: 26px;font-weight: bolder;color: white;background: brown;">Add a Job</p>
				<hr>
				<form style="display:block;" method="POST" action="AddJob.php?added_by=<?php echo $roll; ?>" style="height: auto;">
				    ...
				    <div class="row" style="width: 100%;display: ruby;">
				        ...
				        <input type="text" id="job_title" name="Title" placeholder="Job Title...">
				    ...
				    <div class="row" style="width: 100%;display: ruby;">
				        ...
				        <input style="width:100px;" type="text" id="date" name="Date" placeholder="Date...">
				        <select name="Month" style="width:100px;height:40px;">
				            <option>Month</option>
				        ...
				        <input style="width:100px;" type="text" id="year" name="Year" placeholder="Year...">
				    ...
				    <div class="row" style="width: 100%;">
				        ...
				        <textarea id="require" name="Require" rows="30" cols="50"></textarea>
