	...
	<body>
		...
		<div class="big clear">
			...
			<div class="selecter clear">
				...
				<button class="photos iactive clear" onclick="document.location.href='gallery.php'">PHOTOS</button><button class="albums clear" onclick="document.location.href='albums.php'">ALBUMS</button>
