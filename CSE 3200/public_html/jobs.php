	...
	<body>
		...
		<div class="big clear">
			...
			<div class="selecter clear">
				...
				<button class="photos clear" onclick="document.location.href='careers.php'">ADVICES</button><button class="albums iactive clear" onclick="document.location.href='jobs.php'">JOBS</button>

			</div>

			<div class="add_selecter clear">

				<button onclick="document.location.href='<?php if (isset($_SESSION['user'])) echo "addJob.php?added_by=".$roll; ?>'" class="add_photos clear">Add Jobs</button>
			...
			<div class="main_div clear">
				...
				<?php
					...
					$cnt = $cnt + 1; ?>
						<a href="viewJob.php?id=<?php echo $row['id']; ?>" class="event clear" style="height:auto;">
							<div class="calendar_block">
						    	<p class="calendar_day">DEADLINE</p>
						  	...
						  	<div class="event_details_block">
						    	...
						    	<div class="event_details_extra">
                                    <p class="event_venue"><strong>Company : </strong></br><?php echo $row['company']; ?></p>
						      		<p class="event_venue"><strong>Post : </strong></br><?php echo $row['post']; ?></p>
						    	</div>
						  	</div>
						 </a>
