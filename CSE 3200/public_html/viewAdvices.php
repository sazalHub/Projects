		...
		<div class="big clear">
			...
			<div class="main_div clear">
				...
				<?php
					...
					$sql = "select * from advices where id='$idn'";
				...
				<div class="slide clear" style="height: 300px;position: relative;margin-left:0px;">
					...
					<img src="defaultImages/pexels-photo-web-design.jpg" style="opacity: 0.5;">

					<div class="slide_detail clear" style="position: absolute;left: 55%;top: 10%;">
						<p style="font-size: 30px;font-weight: bolder;"> <?php echo $answer['title']; ?> </p>
						<p style="font-size: 30px;color: currentColor;"> <?php echo $answer['date']," ",$answer['month'],",",$answer['year']; ?> </p>
					</div>

					<div class="slide_detail clear" style="position: absolute;left: 55%;top: 65%;">
						<p style="font-size: 30px;font-weight: bolder;"> WRITTEN BY- </p>
						<p style="font-size: 25px;"> SAZAL KUMAR SARKAR </p>
					</div>
					
				</div>

				<div class="event_detail clear">
					<header style="text-align: left;">ADVICE</header>
					<hr>
					...
					<div class="event_des clear" style="">
						...
						<div class="detail_des clear" style="text-align: left;width: 510px;background: white;float: left;margin: 10px;font-size: 20px;">
							<p style="margin: 10px;text-align: justify;"><?php echo nl2br($answer['advice']); ?> </p>
						</div>
						...
						<div class="time clear" style="width: 200px;min-height: 10px;margin: 10px;background: white;text-align: center;">
							...
							<p style="margin: 10px;text-align: justify;">WILL START AT: <?php echo $answer['shour'],":",$answer['smin']; ?></p>
							<p style="margin: 10px;text-align: justify;">&nbsp; &nbsp; WILL END AT: <?php echo $answer['ehour'],":",$answer['emin']; ?></p>
					    ...
					    <script>    
					        function initMap(address) {
					            ...
					            var address = "<?php echo $answer['venue']; ?>,Rajshahi";
					    ...
					    <div class="event_links clear" style="width: 460px;height: 300px;margin: 10px;">
					    	...
					    	<div class="event_follow_links">
					    		...
					    		<a href="http://www.<?php echo $answer['links']; ?>"><i class="fa fa-registered" style="font-size: 33px;"></i></a>
					    		<a href="http://www.<?php echo $answer['links']; ?>"><i class="fa fa-question-circle"></i></a>
					    	</div>
					    ...
					    <?php }
					    	...
					    	<script type="text/javascript">
					    		...
					    		document.getElementsByClassName("detail_des")[0].style.width = "98%";
